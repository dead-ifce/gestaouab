...
<h2><?php  __('Disciplina');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $disciplina['Disciplina']['id']; ?>
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $disciplina['Disciplina']['carga']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Semestre'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $disciplina['Disciplina']['semestre']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Numsemanas'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $disciplina['Disciplina']['numsemanas']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Disciplina', true), array('action' => 'edit', $disciplina['Disciplina']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Disciplina', true), array('action' => 'delete', $disciplina['Disciplina']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $disciplina['Disciplina']['id'])); ?> </li>
